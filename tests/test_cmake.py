...
@pytest.mark.parametrize(
    ("descriptor_name", "message_name"),
    [
        ("api/demo;legacy.proto", "SemicolonName"),
        ("x" * 255 + "/portable.proto", "LongPortablePath"),
    ],
)
def test_descriptor_set_library_builds_portable_descriptor_name(
    ...
    if os.name == "nt":
        ...
        assert "CMAKE_GENERATOR:INTERNAL=Visual Studio " in cache
