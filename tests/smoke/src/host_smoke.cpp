...
namespace {
    ...
    static_assert(Message::HEX_E_DIGITS == 48879u);
    ...
    static_assert(test::ultimate::BITWISE_BASE == 10u);
    static_assert(test::open::Mode_MIN == Proto3OpenMode::MODE_UNSPECIFIED);
    static_assert(test::open::Mode_MAX == Proto3OpenMode::MODE_READY);
    static_assert(test::open::Mode_ARRAYSIZE == 2);
    static_assert(test::open::Mode_is_valid(0));
    static_assert(test::open::Mode_is_valid(1));
    static_assert(!test::open::Mode_is_valid(7));
    static_assert(test::required::Proto2DefaultMode_MIN == Proto2DefaultMode::PROTO2_DEFAULT_MODE_UNKNOWN);
    static_assert(test::required::Proto2DefaultMode_MAX == Proto2DefaultMode::PROTO2_DEFAULT_MODE_READY);
    static_assert(test::required::Proto2DefaultMode_ARRAYSIZE == 10);
    static_assert(test::required::Proto2DefaultMode_is_valid(5));
    static_assert(test::required::Proto2DefaultMode_is_valid(9));
    static_assert(!test::required::Proto2DefaultMode_is_valid(7));
    static_assert(Message::Color_MIN == Color::COLOR_UNSPECIFIED);
    static_assert(Message::Color_MAX == Color::BLUE);
    static_assert(Message::Color_ARRAYSIZE == 4);
    static_assert(Message::Color_is_valid(2));
    static_assert(!Message::Color_is_valid(4));
    static_assert(Nested2::InnerEnum_MIN == InnerMode::INNER_UNSPECIFIED);
    static_assert(Nested2::InnerEnum_MAX == InnerMode::C);
    static_assert(Nested2::InnerEnum_ARRAYSIZE == 4);
    static_assert(Nested2::InnerEnum_is_valid(3));
    static_assert(!Nested2::InnerEnum_is_valid(-1));
    static_assert(Message::I32_BITWISE == -1);
    static_assert(Message::U32_BITWISE == 4294967295u);
    static_assert(Message::I64_BITWISE == 1099511627776ll);
    static_assert(Message::U64_BITWISE == 18446744073709551600ull);
    static_assert(Message::F32_BITWISE == 9.0f);
    static_assert(Message::F64_BITWISE == 16.0);
    ...
    static_assert(!Message::MIXED_COMPARE);
    static_assert(Message::MIXED_EQUAL);
    static_assert(Message::F32_EQUAL_SOURCE == 16777216.0f);
    static_assert(Message::MIXED_F32_EQUAL);
    static_assert(Message::BITWISE_SOURCE_NORMALIZED == 0ll);
    static_assert(Message::SHIFT_COUNT_NORMALIZED == 2);
    static_assert(Message::CAST_U32 == 4294967295u);
    static_assert(Message::CAST_I32 == -1);
    static_assert(Message::CAST_I64 == -1ll);
    static_assert(Message::CAST_U64 == 18446744073709551615ull);
    static_assert(Message::CAST_F32 == 16777216.0f);
    static_assert(Message::CAST_F64 == 16777216.5);
    static_assert(Message::CAST_BOOL);
    static_assert(Message::CAST_STR == std::string_view {"-1", 2u});
    static_assert(Message::STR_BITWISE == std::string_view {"b", 1u});
    static_assert(test::ultimate::MATH_BASE == 3u);
    static_assert(Message::MATH_POW == 32);
    static_assert(Message::MATH_U64_POW == 9223372036854775808ull);
    static_assert(Message::MATH_ABS == 9ll);
    static_assert(Message::MATH_MIN == 3u);
    static_assert(Message::MATH_F32 == 1.5625f);
    static_assert(Message::MATH_EXP == 1.0);
    static_assert(Message::MATH_LOG == 2.0);
    static_assert(Message::MATH_LOG2 == 4.0);
    static_assert(Message::MATH_LOG10 == 3.0);
    static_assert(Message::MATH_CEIL == -2.0);
    static_assert(Message::MATH_FLOOR == -3.0);
    static_assert(Message::MATH_TRUNC == -2.0);
    ...
    static_assert(Message::MATH_STR == std::string_view {"b", 1u});
...
TEST_CASE("byte setters accept contiguous byte containers", "[smoke][runtime][bytes]") {
    ...
    constexpr char trailing_nul_bytes_payload[] {'x', 'y', '\0'};
    require_success(message.set_f_bytes(trailing_nul_bytes_payload));
    const auto trailing_nul_bytes_view = protocyte::byte_span_of(trailing_nul_bytes_payload);
    REQUIRE(trailing_nul_bytes_view);
    CHECK(message.f_bytes().size() == 3u);
    CHECK(view_equal(message.f_bytes(), *trailing_nul_bytes_view));
